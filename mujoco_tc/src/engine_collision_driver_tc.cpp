...
#include <mujoco_tc/mjsan.h>  // IWYU pragma: keep
#include "mujoco_tc/engine_callback.h"
#include "mujoco_tc/engine_collision_convex_tc.h" 
#include "mujoco_tc/engine_collision_primitive_tc.h"
// #include "mujoco_tc/engine_collision_sdf_tc.h"
#include "mujoco_tc/engine_core_constraint_tc.h"
#include "mujoco_tc/engine_io_tc.h"
#include "mujoco_tc/engine_macro.h"
#include "mujoco_tc/engine_sort.h"
#include "mujoco_tc/engine_support_tc.h"
#include "mujoco_tc/engine_util_blas_tc.h"
//#include "mujoco_tc/engine_util_errmem_tc.h"
...
// TC: Only allow collision detection supported in native Mujoco CCD, i.e. plane, sphere, capsule, cyclinder, and box
...
mjfCollision mjCOLLISIONFUNC[mjNGEOMTYPES][mjNGEOMTYPES] = {
    ...
    /*PLANE     */ {0,     0,      mjc_PlaneSphere,  mjc_PlaneCapsule,   0,                mjc_PlaneCylinder,  mjc_PlaneBox,     0,                0},
    /*HFIELD    */ {0,     0,      0,                0,                  0,                0,                  0,                0,                0},
    /*SPHERE    */ {0,     0,      mjc_SphereSphere, mjc_SphereCapsule,  0,                mjc_SphereCylinder, mjc_SphereBox,    0,                0},
    /*CAPSULE   */ {0,     0,      0,                mjc_CapsuleCapsule, 0,                0,                  mjc_CapsuleBox,   0,                0},
    /*ELLIPSOID */ {0,     0,      0,                0,                  0,                0,                  0,                0,                0},
    /*CYLINDER  */ {0,     0,      0,                0,                  0,                0,                  0,                0,                0},
    /*BOX       */ {0,     0,      0,                0,                  0,                0,                  mjc_BoxBox,       0,                0},
...
//mjfCollision mjCOLLISIONFUNC[mjNGEOMTYPES][mjNGEOMTYPES] = {
//  /*              PLANE  HFIELD  SPHERE            CAPSULE             ELLIPSOID         CYLINDER            BOX               MESH              SDF */
//  /*PLANE     */ {0,     0,      mjc_PlaneSphere,  mjc_PlaneCapsule,   mjc_PlaneConvex,  mjc_PlaneCylinder,  mjc_PlaneBox,     mjc_PlaneConvex,  0},
//  /*HFIELD    */ {0,     0,      mjc_ConvexHField, mjc_ConvexHField,   mjc_ConvexHField, mjc_ConvexHField,   mjc_ConvexHField, mjc_ConvexHField, 0},
//  /*SPHERE    */ {0,     0,      mjc_SphereSphere, mjc_SphereCapsule,  mjc_Convex,       mjc_SphereCylinder, mjc_SphereBox,    mjc_Convex,       0},
//  /*CAPSULE   */ {0,     0,      0,                mjc_CapsuleCapsule, mjc_Convex,       mjc_Convex,         mjc_CapsuleBox,   mjc_Convex,       0},
//  /*ELLIPSOID */ {0,     0,      0,                0,                  mjc_Convex,       mjc_Convex,         mjc_Convex,       mjc_Convex,       0},
//  /*CYLINDER  */ {0,     0,      0,                0,                  0,                mjc_Convex,         mjc_Convex,       mjc_Convex,       0},
//  /*BOX       */ {0,     0,      0,                0,                  0,                0,                  mjc_BoxBox,       mjc_Convex,       0},
//  /*MESH      */ {0,     0,      0,                0,                  0,                0,                  0,                mjc_Convex,       0},
//  /*SDF       */ {0,     0,      0,                0,                  0,                0,                  0,                0,                0}
//};
...
// TC: Commented out flex self-collisions section
...
void mj_collideGeoms(const mjModel* m, mjData* d, int g1, int g2) {
  ...
  mjContact* con =
    (mjContact*) mj_arenaAllocByte(d, sizeof(mjContact) * mjMAXCONPAIR, 1);
  if (!con) {
