...
struct SplineTraits<Spline<_Scalar, _Dim, _Degree>, Dynamic> {
    ...
    enum {
        OrderAtCompileTime = _Degree == Dynamic
                                 ? Dynamic
    ...
    typedef Array<Scalar, Dynamic, Dynamic, RowMajor, NumOfDerivativesAtCompileTime,
                  OrderAtCompileTime>
        BasisDerivativeType;
...
struct SplineTraits<Spline<_Scalar, _Dim, _Degree>, _DerivativeOrder>
    ...
    enum {
        DerivativeMemoryLayout =
            _Dim == 1 ? RowMajor : ColMajor /*!< The derivative type's memory layout. */
    };

    /** \brief The data type used to store the values of the basis function derivatives. */
    typedef Array<_Scalar, Dynamic, Dynamic, RowMajor, NumOfDerivativesAtCompileTime,
                  OrderAtCompileTime>
        BasisDerivativeType;
