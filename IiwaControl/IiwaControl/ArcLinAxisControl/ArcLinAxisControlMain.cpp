...
class CArcLinAxisControlCtrl : public ITcOCFCtrlImpl<CArcLinAxisControlCtrl, CArcLinAxisControlClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("ArcLinAxisControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CArcLinAxisControlCtrl>;
