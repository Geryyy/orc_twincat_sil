...
///<AutoGeneratedContent id="Members">
	...
	typedef _TCOM_SMARTDATAPTR<matrix_2_real_T> matrix_2_real_TDataPtr;
	...
	kuka_moduleLinearAxisParameters m_LinearAxisParameters;
	double m_mass_tool;
	double m_cog_tool[3];
	double m_tcp_tool[6];
	double m_WorldTranslation[3];
	double m_WorldRotation[3];
	kuka_moduleWorkspaceLimitPreset m_WorkspaceLimitPreset;
	double m_CustomWorkspaceLimits[6];
	bool m_Is9DOF;
	...
	kuka_moduleMotorcontrollerInput m_MotorcontrollerInput;
	kuka_moduleMotorcontrollerOutput m_MotorcontrollerOutput;
	...
	matrix_2_real_TDataPtr m_spfast_control_axis_enable;
	matrix_2_real_TDataPtr m_spfast_control_axis_force;
	matrix_2_real_TDataPtr m_spfast_control_axis_position;
	matrix_2_real_TDataPtr m_spfast_control_axis_velocity;
	matrix_2_real_TDataPtr m_spfast_sensor_axis_force;
	matrix_2_real_TDataPtr m_spfast_sensor_axis_position;
	matrix_2_real_TDataPtr m_spfast_sensor_axis_velocity;
///</AutoGeneratedContent>
