...
class CRoboSimFastCtrl : public ITcOCFCtrlImpl<CRoboSimFastCtrl, CRoboSimFastClassFactory>
{
public:
	CRoboSimFastCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("RoboSimFast: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CRoboSimFastCtrl>;
