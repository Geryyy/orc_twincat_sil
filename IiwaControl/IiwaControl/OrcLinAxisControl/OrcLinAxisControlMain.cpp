...
class COrcLinAxisControlCtrl : public ITcOCFCtrlImpl<COrcLinAxisControlCtrl, COrcLinAxisControlClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("OrcLinAxisControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<COrcLinAxisControlCtrl>;
