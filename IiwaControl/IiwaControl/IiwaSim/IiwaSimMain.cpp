...
class CIiwaSimCtrl : public ITcOCFCtrlImpl<CIiwaSimCtrl, CIiwaSimClassFactory>
{
public:
	CIiwaSimCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("IiwaSim: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CIiwaSimCtrl>;
