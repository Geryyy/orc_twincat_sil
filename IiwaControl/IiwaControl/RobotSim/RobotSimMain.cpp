...
class CRobotSimCtrl : public ITcOCFCtrlImpl<CRobotSimCtrl, CRobotSimClassFactory>
{
public:
	CRobotSimCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("RobotSim: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CRobotSimCtrl>;
