...
class COrcTcControlCtrl : public ITcOCFCtrlImpl<COrcTcControlCtrl, COrcTcControlClassFactory>
{
public:
	COrcTcControlCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("OrcTcControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<COrcTcControlCtrl>;
