...
class CArcTcControlCtrl : public ITcOCFCtrlImpl<CArcTcControlCtrl, CArcTcControlClassFactory>
{
public:
	CArcTcControlCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("ArcTcControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CArcTcControlCtrl>;
